		...
		<div class="wrap_inner  ">
			<div class="f_l" style='margin:0;'>
				<button id="btnServiceMenu" type="button"
					class="f_l text_hide btn_menu img_ico #sidebar ">메뉴</button>
				...
				<div class="wrap_btn_search ">
					<form action="/search" method="get">
						<input name="q" id="searchQuery" type="text"
							placeholder="검색어를 입력해 주세요" autocomplete="off" value="" /> <input
							name="profileId" type="hidden" value="" />
					</form>
					<button id="btnServiceMenuSearch" type="button"
						class="f_r img_ico text_hide btn_search #search_btn">검색</button>
				</div>
			</div>
		</div>
	</div>
		...
		<c:choose>
			...
			<ul>
				<li><a class="menu_word4 #side_home brunchHomeLink"
					href="#"><span class="bar_left"></span>내 영화노트<span
						class="bar_right"></span></a></li>
				<li><a class="menu_word5 #side_ready" href="/ready"><span
						class="bar_left"></span>작가의 서랍<span class="bar_right"></span></a></li>
				<li class="hr"></li>
				<li><a class="menu_word4 #side_brunch" href="/"><span
						class="bar_left"></span>영화노트 홈<span class="bar_right"></span></a></li>
				<li><a class="menu_word5 #side_now brunchNowLink" href="/now"><span
						class="bar_left"></span>영화노트 나우<span class="bar_right"></span></a></li>
				<li><a class="menu_word5 #side_publish brunchPublishLink"
					href="/publish"><span class="bar_left"></span>영화노트 책방<span
						class="bar_right"></span></a></li>
				<li><a class="menu_word2 #side_feed brunchFeedLink"
					href="/feed"><span class="bar_left"></span>피드<span
						class="bar_right"></span></a></li>
			</ul>
		</div>
		</main>
